...
declare type AssetPerson = {
    user: {
        username: string;
    };
    address: string;
} | null;
declare type AssetOwner = AssetPerson;
declare type AssetCreator = AssetPerson;
...
export declare type OpenSeaAssetExtended = OpenSeaAsset & {
    wallet: string;
};
...
export declare type OpenSeaEventExtended = Omit<OpenSeaEvent, 'asset'> & {
